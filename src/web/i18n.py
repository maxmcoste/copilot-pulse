...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    # ── Virtual FTE ──────────────────────────────────────────
    "vfte_title": {"en": "Virtual FTE Analysis (13 weeks)", "it": "Analisi FTE Virtuali (13 settimane)"},
    "vfte_help": {
        "en": "Estimates how many virtual developers Copilot has added to the team based on accepted code lines.\n\nFormula: FTE_Virtuali = (lines_accepted × (1 − review_overhead)) / (lines_per_day × working_days)\n\nMonthly ROI = FTE_Virtuali × hourly_rate × daily_hours × working_days\n\nEach weekly Wednesday sample is scaled ×7 to approximate the full week contribution.",
        "it": "Stima quanti sviluppatori virtuali Copilot ha aggiunto al team in base alle linee di codice accettate.\n\nFormula: FTE_Virtuali = (linee_accettate × (1 − overhead_revisione)) / (linee_giorno × giorni_lavorativi)\n\nROI Mensile = FTE_Virtuali × costo_orario × ore_giornaliere × giorni_lavorativi\n\nOgni campione settimanale (mercoledi') viene scalato ×7 per approssimare il contributo settimanale completo.",
    },
    "vfte_lines_per_day": {"en": "Human lines/day (baseline)", "it": "Linee umane/giorno (baseline)"},
    "vfte_lines_unit": {"en": "lines", "it": "righe"},
    "vfte_working_days": {"en": "Working days/month", "it": "Giorni lavorativi/mese"},
    "vfte_days_unit": {"en": "days", "it": "giorni"},
    "vfte_review_overhead": {"en": "Review overhead", "it": "Overhead revisione"},
    "vfte_hourly_rate": {"en": "Developer hourly rate", "it": "Costo orario sviluppatore"},
    "vfte_daily_hours": {"en": "Daily work hours", "it": "Ore lavorative giornaliere"},
    "vfte_recalculate": {"en": "Recalculate", "it": "Ricalcola"},
    "vfte_col_period": {"en": "Period", "it": "Periodo"},
    "vfte_col_lines": {"en": "Lines Accepted", "it": "Linee Accettate"},
    "vfte_col_vol_ide": {"en": "IDE Lines", "it": "Linee IDE"},
    "vfte_col_vol_agent": {"en": "Agent Lines", "it": "Linee Agent"},
    "vfte_col_total_lines": {"en": "Total Lines (net)", "it": "Linee Totali (nette)"},
    "vfte_lines_per_agent_edit": {"en": "Lines per agent edit", "it": "Linee per agent edit"},
    "vfte_col_capacity": {"en": "Human Capacity", "it": "Capacità Umana"},
    "vfte_col_fte": {"en": "Virtual FTE", "it": "FTE Virtuali"},
    "vfte_col_value": {"en": "Monthly Value", "it": "Valore Mensile"},
    "vfte_insight_prefix": {"en": "Thanks to Copilot adoption, the organisation operated as if it had added", "it": "Grazie all'adozione di Copilot, l'organizzazione ha operato come se avesse aggiunto"},
    "vfte_insight_suffix": {"en": "developers to the team, increasing productive capacity without changes to actual headcount.", "it": "sviluppatori al team, aumentando la capacità produttiva senza variazioni nell'headcount reale."},
    "vfte_monthly_roi": {"en": "Monthly ROI (latest period)", "it": "ROI Mensile (ultimo periodo)"},
    "vfte_avg_fte": {"en": "Avg. Virtual FTE (13w)", "it": "FTE Virtuali medi (13s)"},
    "vfte_no_data": {"en": "No line data available yet. Lines accepted will appear once weekly samples have been collected.", "it": "Nessun dato sulle linee disponibile. I dati appariranno una volta raccolti i campioni settimanali."},
    "roi_help": {
